...
**The final `"$REPO/mfast-seqs/scripts"` argument is also not
optional.** SLURM copies a submitted script into a per-job spool
directory (`/var/spool/slurmd/...`) and runs that copy, so
